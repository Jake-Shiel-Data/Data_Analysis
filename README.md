# Jake Shiel's Data Analyst Projects & Learning Journey
...
### 4. **R**
   - **Project**: [Project Title] - (e.g., "Customer Segmentation") A project where I used R for statistical analysis and data visualization.
